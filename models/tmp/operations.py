...
OPS = {
  'none' : lambda C, stride, affine, single_sepConv: Zero(stride),
  'avg_pool_3x3' : lambda C, stride, affine, single_sepConv: nn.AvgPool2d(3, stride=stride, padding=1, count_include_pad=False),
  'max_pool_3x3' : lambda C, stride, affine, single_sepConv: nn.MaxPool2d(3, stride=stride, padding=1),
  'skip_connect' : lambda C, stride, affine, single_sepConv: Identity() if stride == 1 else FactorizedReduce(C, C, affine=affine),
  ...
  'merge_conv_normal' : lambda C, stride, affine, single_sepConv, with_d5: MergeConv(C, C, 5, stride, 4, affine=affine),
  'merge_conv_v0' : lambda C, stride, affine, single_sepConv, with_d5: MergeSepConv_v0(C, C, 5, stride, 4, affine=affine),
  'sep_conv_3x3' : lambda C, stride, affine, single_sepConv: SepConv(C, C, 3, stride, 1, affine=affine, single=single_sepConv),
  'sep_conv_5x5' : lambda C, stride, affine, single_sepConv: SepConv(C, C, 5, stride, 2, affine=affine, single=single_sepConv),
  'sep_conv_7x7' : lambda C, stride, affine, single_sepConv: SepConv(C, C, 7, stride, 3, affine=affine, single=single_sepConv),
  'dil_conv_3x3' : lambda C, stride, affine, single_sepConv: DilConv(C, C, 3, stride, 2, 2, affine=affine, single=single_sepConv),
  'dil_conv_5x5' : lambda C, stride, affine, single_sepConv: DilConv(C, C, 5, stride, 4, 2, affine=affine, single=single_sepConv),
  ...
  'conv_7x1_1x7' : lambda C, stride, affine, single_sepConv: nn.Sequential(
