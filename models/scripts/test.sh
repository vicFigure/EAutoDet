...
CUDA_VISIBLE_DEVICES=${gpu[0]} python test.py --data $data --batch-size $BATCHSIZE --img 640 512 416 --conf 0.001 --iou 0.65 --weights $project/full_train3/weights/stripped_best.pt --project $project --name test > $LOG_DIR/$ID-test.log 2>&1 &
